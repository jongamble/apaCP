 ...
 * 
 * This class is being used to handle all Create, Read, 
 * Update, Delete requests to the database. This database 
 * will be used to keep track of which sites have been 
 * created on the server for faster administration.
 *
